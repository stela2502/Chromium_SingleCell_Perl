package stefans_libs::database::Chromium_SingleCell::genes;
...
sub new {
    ...
    bless $self, $class if ( $class eq "stefans_libs::database::Chromium_SingleCell::genes" );
